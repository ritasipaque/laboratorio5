...
public class RegistroMaestros extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       try{
           ...
           cn = DriverManager.getConnection("jdbc:mysql://localhost/bd_ins10", "root", "");
            ...
            if(rs.next()){
                txt_NombreMaestros.setText(rs.getString("NombreMestro"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            pst.setString(1, txt_NombreMaestros.getText().trim());
            pst.setString(2, txt_CorreoMaestro.getText().trim());
            pst.setString(3, txt_telefonoMaestro.getText().trim());
            pst.setString(4, txt_DireccionMaestro.getText().trim());
            pst.executeUpdate();
